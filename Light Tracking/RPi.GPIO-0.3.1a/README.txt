...
::
    ...
    #To use GPCLK0:
    GPIO.setmode(GPIO.BCM)
    GPIO.setup(4, GPIO.ALT0)  #Probably best to leave pull up/down alone!
    GPIO.setclock(4,64000)		#Sets the divisors for 64kHz output
    GPIO.output(4,1)  #turn on clock output
    GPIO.output(4,0)  #turn off clock output
