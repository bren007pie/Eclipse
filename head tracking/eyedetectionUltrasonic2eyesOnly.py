...
cap = cv2.VideoCapture(0) #sets up video capture
...
while 1:
    ...
    for (x,y,w,h) in faces:
        ...
        #print(faces) #prints the contents of the faces arrays
        
        eyes = eye_cascade.detectMultiScale(roi_gray)
        
        
        
        #Getting the Eye Centres
##        eyecentres = [] #empty list
##        for (ex,ey,ew,eh) in eyes:
##            eyecentres.append([x+ex+ew/2, y+ey+eh/2]) #appending  for each eye
##        print(eyecentres)
