#coppied from Rabin Poudyal
#https://blog.goodaudience.com/real-time-face-and-eyes-detection-with-opencv-54d9ccfee6a8
#https://github.com/rabinpoudyal/100DaysOfMachineLearningCode/blob/master/ComputerVisionWithOpenCV/FaceDetection/face_detector.py
